...
var spotifyApi = new SpotifyWebApi({
  clientId : 'e374fd87644b40d0a0ec04a1aa39ea68',
  clientSecret : '7a9a586ddab94ce9ba1e897880c48cef'
});
...
spotifyApi.clientCredentialsGrant()
  .then(function(data) {
    ...
    return spotifyApi.getArtistTopTracks('4dwdTW1Lfiq0cM8nBAqIIz', 'MX')
  }).then(function(data) {
    console.log('The most popular tracks for Of Monsters and Men in Mexixo are...');
